...
class ActionCableProvider extends React.Component {
  ...
  render() {
    return <Provider value={{ cable: this.cable }}>{this.props.children || null}</Provider>
  }
}
...
var ActionCableConsumerWithRef = React.forwardRef(function (props, ref) {
...
var ActionCableConsumer = createReactClass({
  render: function () {
    return React.createElement(Consumer, null, ({ cable }) => {
      return React.createElement(
        ActionCableController,
        {
          cable,
          ...this.props,
          ref: this.props.forwardedRef || null
        },
